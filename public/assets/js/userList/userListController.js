define(['./userList', 'lodash'], function(userList) {
	...
	userList.controller('userListController', function($scope, $http, $window, userListFactory, $state, $timeout, SweetAlert, flowFactory){
