define(['angular', '../class', 'moment', '../classFactory'], function(angular, classModule, moment) {

		'use strict';

		classModule.controller('classScheduleController', 
			function($scope, $rootScope, $http, $window, $state, $timeout, SweetAlert, flowFactory, $stateParams, ngTableParams, $filter, $aside, classFactory){
					    ...
					    function refreshCalendarEvents(event){
					    	...
					    	_.forEach($scope.events, function(e) {
					    		if (!e._id){
					    			classFactory.createEvent($scope.clazz._id, e);
					    		}
					    ...
					    $scope.addEvent = function () {
					    	...
					    	console.log('Adding event for class ' + $scope.clazz._id + ' and trainer ' + $scope.userid);
					    	
					    	var event = {		class:$scope.clazz._id,
					    						trainer: $scope.userid,
												eventTime : {
												},
												eventDate: {
												},
